...
$dbname = "tareasDB";       // Reemplaza con el nombre de tu base de datos
        ...
        <p>Para la realizacion de este proyecto utilizamos.</p>
        <ol>
            <li><strong>PHP:</strong> Se utilizo para la estructura de la pagina web.</li>
            <li><strong>Mysql:</strong> Lo utilizamos para guardar las tareas que va a agregar el usuario.</li>
            <li><strong>JavaScript:</strong> Se utilizo para el funcionamiento de la pagina web.</li>
            <li><strong>CSS:</strong> lo utilizamos para el diseño de la pagina web.</li>
        </ol>
    </div>
</body>
</html>
